...
export default function Start() {
    ...
    return (
        <div className="justify-between start-screen p-5 flex  flex-col gap-5 min-h-[100dvh] dark:text-darkText">
            ...
            <p className="text-center text-sm px-4">Routine helps you to store and manage your routines.</p>
            ...
            <div className="btnWrapper">
                ...
                <p className="text-center text-xs pt-2 text-black/60 dark:text-darkText/50">Read <Link to='' className="text-link">Terms and Conditions</Link> before continuing.</p>
            </div>
        </div>
    )
}